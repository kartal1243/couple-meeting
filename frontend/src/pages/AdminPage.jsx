  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0a0e14, #0f172a)', color: '#e2e8f0', fontFamily: "'Inter', -apple-system, sans-serif" }}>
      ...
      <div style={{ padding: '20px 24px', maxWidth: 1400, margin: '0 auto' }}>
        ...
        {/* ═══════════ LOGS ═══════════ */}
        {tab === 'logs' && <LogsTab logs={logs} logSearch={logSearch} setLogSearch={setLogSearch} filteredLogs={filteredLogs} logRoomFilter={logRoomFilter} setLogRoomFilter={setLogRoomFilter} rooms={rooms} formatTime={formatTime} />}
