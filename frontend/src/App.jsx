...
const GLOBAL_CSS = `
  ...
  @media (max-width: 900px) { .cm-hero{grid-template-columns:1fr; padding-top:35px}.cm-demo-wrap{min-height:390px}.cm-feature-grid{grid-template-columns:1fr 1fr}.cm-float.a{right:8px}.cm-float.b{left:8px} }
  @media (max-width: 620px) { .cm-landing-nav{padding:14px 16px}.cm-brand-mark{width:40px;height:40px}.cm-hero{padding:30px 16px 20px}.cm-hero h2{font-size:44px;letter-spacing:-1.8px}.cm-hero-sub{font-size:15px}.cm-hero-actions{display:grid;grid-template-columns:1fr}.cm-hero-actions button{width:100%}.cm-proof-row{gap:10px 14px}.cm-demo-wrap{min-height:350px}.cm-demo-card{transform:none;border-radius:22px;padding:10px}.cm-demo-player{height:190px}.cm-float{display:none}.cm-section{padding:25px 16px 55px}.cm-feature-grid{grid-template-columns:1fr}.cm-section-title{font-size:27px} }
