      ...
      <div className="cm-landing" style={{ ...cssVars }}>
              ...
              <div className="cm-demo-users">
                <div className="cm-avatar-stack">
                  {roomUsersList.length > 0 ? (
                    roomUsersList.slice(0, 4).map((u, i) => (
                      <div key={i} className="cm-avatar" title={u.username}>{u.avatar || '🐱'}</div>
                    ))
                  ) : (
                    <div className="cm-avatar">{myAvatar}</div>
                  )}
                </div>
                <div className="cm-live-pill">● {roomUsersList.length || 1} kişi canlı</div>
              </div>
            </div>
          </div>
        </main>
        ...
        <section className="cm-section" style={{ paddingBottom: '10px' }}>
          <div style={{ textAlign: 'center', marginBottom: 20 }}>
            ...
            <h3 className="cm-section-title" style={{ fontSize:'26px', margin: '0 auto 8px' }}>Aktif Odalar</h3>
            <p className="cm-section-sub" style={{ margin:0, fontSize:'13px' }}>Şu an açık olan odalara doğrudan katılabilirsin.</p>
          </div>

          {publicRooms.length === 0 ? (
            <div className="cm-glass" style={{ padding: '24px', borderRadius: '16px', textAlign: 'center', color: '#8696a0', fontSize: '13px', border: '1px solid rgba(255,255,255,.06)', maxWidth: '600px', margin: '0 auto' }}>
        ...
        <section style={{ position:'relative', zIndex:2, maxWidth:1180, margin:'0 auto', padding:'10px 26px 45px' }}>
          <div className="cm-glass" style={{ borderRadius:28, padding:'28px', border:'1px solid rgba(0,168,132,.18)', display:'flex', flexDirection:'column', alignItems:'center', textAlign:'center', gap:16, background:'linear-gradient(135deg,rgba(13,23,29,.82),rgba(10,15,22,.72))' }}>
            <div>
        ...
        <div ref={roomCardRef} style={{ scrollMarginTop: '40px' }}>
          <section style={{ position:'relative', zIndex:3, maxWidth:660, margin:'0 auto', padding:'0 16px 40px' }}>
            <div className="cm-glass" style={{ ...styles.card, borderRadius:24, border:'1px solid rgba(255,255,255,.08)' }}>
              ...
              {recentRooms.length > 0 && (
                <div style={{ marginTop:20, paddingTop:16, borderTop:'1px solid #222d34' }}>
                  <div style={{ fontSize:10, color:'#8696a0', fontWeight:'bold', marginBottom:8, textAlign: 'center' }}>SON GİRDİĞİN ODALAR</div>
